...
- [x] I want to lose 10kgs by exercising/walking/active 
- [x] Start taking hairloss medication
- [x] Practice mono repo 
- [x] Practice NATS & microservices
- [x] Practice react-native-web
- [x] Start deployment of fee tracker
